<!-- 원본: https://claude-code-playbook-nu.vercel.app/docs/level-3/large-codebase -->

# 대규모 코드베이스 | Claude Code 플레이북
...
# 더 좋은 예 (파일 지정)
> src/domain/order/order.repository.ts 에서 쿼리 최적화할 부분 찾아줘
```
