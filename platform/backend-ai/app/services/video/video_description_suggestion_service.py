...
from app.schemas.video import DescriptionSuggestionResponse
...
class VideoDescriptionSuggestionService:
    def __init__(self, db: Session):
        self.db = db
        self.video_repo = VideoCourseRepository(db)

    def suggest_description(self, video_uuid: UUID, original_description: str) -> DescriptionSuggestionResponse:
        ...
        try:
            prompt = load_prompt("description_suggestion_prompt.j2", {
        ...
        return DescriptionSuggestionResponse(description=description)
